...
insert into `zs_user`(`id`,`user_name`,`password`,`login_times`,`last_login_ip`,`last_login_time`,`real_name`,`status`,`role_id`) values('1','admin','21232f297a57a5a743894a0e4a801fc3','42','127.0.0.1','1512983023','admin','1','1');
